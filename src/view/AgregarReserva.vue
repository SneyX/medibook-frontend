  ...
  <div class="mainContainer">
    <div class="contenedor">
      <div class="calendarios">
        <!-- Date picker -->
        <vue-cal
          class="vuecal--date-picker calendario"
          :xsmall="true"
      ...
      <div class="calendarios mx2" style="max-width: 800px">
        <!-- Full-power calendar -->
        <vue-cal
          class="calendario full-cal vuecal--full-height-delete"
          hide-weekends
          :selected-date="selectedDate"
          :time-from="8 * 60"
          :time-to="19 * 60"
...
@media screen and (max-width: 499px) {
  .mainContainer .day-split-header strong {
    display: none;
  }
}
</style>
